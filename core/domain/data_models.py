...
VECTOR_DUMIE: Dict[str, float] = {
    "mean_margin": 1.00,
    "skewness": 0.05,
    "has_numeric":  1.00,
    "num_median_norm": 1.00,
    "numeric_count_norm": 0.30,
    "num_above": 1.00,   
    "num_margin": 0.60,
    "digit_char_frec": 0.65,
    "has_digit": 1.00,
    "area_norm":           0.70,
    "norm_wid":            0.90,
    "width_rel":           0.75,
    "bbox_width_inv":      1.00,
    "bbox_w_dif":          0.80,
    "ratio_area_norm":     0.80,
    "area_inv":            1.00,
    "area_dif":            0.50,
    "aspcrat_inv_norm":    0.85,
    "perimeter_norm":      0.95,
    "perimeter_inv":       1.00,
    "perimeter_dif":       0.80,
    "diag_inv":            1.00,
    ...
    "angle_inv":           0.90,
    "compact":             0.90,
    "prev_xmin_align":     0.90,
    "prev_xmax_align":     0.95,
    "next_xmin_align":     0.95,
    "next_xmax_align":     0.95,
    "align_prev":          0.95,
    "align_next":          0.95,
    "center_aling":        0.95
}