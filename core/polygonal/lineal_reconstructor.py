...
class LineReconstructor:
    ...
    def _reconstruct_lines(self, polygons: List[Dict[str, Any]]) -> Dict[str, str]:
        ...
        id_map: Dict[str, str] = {}
        self.lines_info: Dict[str, Any] = {}  # Almacenamos en atributo de clase
        current_line_polys: List[Dict[str, Any]] = []
        current_line_bbox = None
        line_counter = 1

        def finalize_line(polys, bbox, line_num):
            ...
            self.lines_info[line_id] = {  # Usamos self.lines_info en lugar de variable local
                "bounding_box": bbox,
        ...
        for poly in prepared_sorted:
            ...
            if not current_line_polys:
                ...
                if drops and overlap > 0.3:
                    ...
                    finalize_line(current_line_polys, current_line_bbox, line_counter)
                    line_counter += 1
                    current_line_polys = [poly]
                    current_line_bbox = list(bbox)
    ...
    def get_lines_geometry(self) -> Dict[str, Any]:
        """
