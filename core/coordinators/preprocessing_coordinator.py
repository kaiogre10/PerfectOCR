...
from core.workflow.preprocessing.deskew import Deskewer
...
from core.workflow.preprocessing.multifeaturer import MultiFeacturer
...
class PreprocessingCoordinator:
    ...
    def apply_preprocessing_pipelines(
        ...
        try:
            ...
            # 3. Filtro de ruido sal y pimienta
            step_start = time.time()
            ...
            return {"ocr_images": ocr_images}, total_duration
