    ...
    def transcribe(self, context: Dict[str, Any], manager: DataFormatter) -> bool:
        ...
        for poly_id, polygon in polygons_in.items():
            ...
            if kf or kf is not None:
                ...
                updated_polygon = dataclasses.replace(polygon, ocr_text=original_text)
            ...
            corrected_text = self._apply_corrections(original_text, semantic_clasification=polygon.semantic_clasification)
            # Si hubo cambios, actualizar el polígono
            if corrected_text != original_text and validate_text(corrected_text):
                correced_count +=1
